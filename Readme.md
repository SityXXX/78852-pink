...
* Студент: [Юрий Базалий](https://htmlacademy.ru/profile/id78852).
* Наставник: `Кирилл Хвастунов`.

### Немного о себе
`Мне 25 лет, работаю в небольшой компании веб-разработчиком. Помимо HTML, CSS, JS, интересуюсь и back-end'ом - PHP.`
...
[Откройте репозиторий](https://github.com/up-htmlacademy/78852-pink) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
...
[travis-image]: https://travis-ci.org/up-htmlacademy/78852-pink.svg?branch=master
[travis-url]: https://travis-ci.org/up-htmlacademy/78852-pink
[dependency-image]: https://david-dm.org/up-htmlacademy/78852-pink.svg?style=flat-square
[dependency-url]: https://david-dm.org/up-htmlacademy/78852-pink
